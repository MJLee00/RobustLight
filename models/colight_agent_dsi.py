...
class CoLightDSIAgent(Agent):
    def __init__(self, dic_agent_conf=None, dic_traffic_env_conf=None, dic_path=None, cnt_round=None,
        ...
        #self.inference_model.load_model(os.path.join(self.dic_traffic_env_conf['sota_path'], "round_{0}_inter_0".format(cnt_round+70, self.intersection_id)),  int(self.device[-1]))
